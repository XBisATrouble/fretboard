...
export default function LibraryPage() {
  return <main className="library-page shell">
    <header className="topbar"><a className="brand" href={sitePath("/")}><span>谱</span>练</a><a className="back-library" href={sitePath("/")}>← 返回首页体验</a><a className="library-link" href={sitePath("/fretboard/")}>指板白板</a><a className="library-link" href={sitePath("/arpeggio/")}>琶音练习</a><a className="library-link" href={sitePath("/triads/")}>三和弦练习</a><div className="top-note">第一阶段 · <b>右手单音</b></div></header>
